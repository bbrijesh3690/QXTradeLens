...
Status: B1, B2 and B4 were fixed in v1.20.1; B10, B12, B13 and B14 in v1.21.1; B3 (dead selectors) is covered by the self-repairing lookups in v1.22.0 and v1.25.0. In v1.21.0 the stop loss stopped blocking trading at the
